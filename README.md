Craftia is a built from the ground up "add it all" game, coded in rust with it's own custom engine, also done in rust.

cargo run --release To Compile and Launch
...
- What's the point of this server? This server will serve as the community hub for Craftia, where anyone can join and talk about anything related to Craftia, games, general life stuff, and more. It's also where I'll be posting updates regarding the game's development.
